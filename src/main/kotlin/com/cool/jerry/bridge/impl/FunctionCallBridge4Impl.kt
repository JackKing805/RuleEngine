...
class FunctionCallBridge4Impl(
    val onCall:(params1: Any,params2:Any, params3: Any, params4: Any)->Any
): FunctionCallBridge4 {
    override fun call(params1: Any, params2: Any, params3: Any, params4: Any):Any {
        return onCall(params1,params2,params3,params4)
    }
}